...
* [PageGuard](https://pageguard.org) - Free all-in-one website health scanner covering SEO, performance, accessibility, and best practices, with AI-powered action plans and an open REST API
